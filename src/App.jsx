...
const INIT_DESTINATIONS = [
  {
    id:1, title:"Salto Ángel", state:"Bolívar", municipality:"Gran Sabana",
    category:"Naturaleza", tags:["Cascada","Selva","Aventura"],
    emoji:"🌊", color:"#1A3A5C",
    description:"El Salto Ángel (Kerepakupai Merú) es la cascada más alta del mundo con 979 metros de caída libre. Declarado Patrimonio de la Humanidad, se encuentra en el Parque Nacional Canaima, en el corazón de la Guayana venezolana.",
    access:"Vuelo desde Ciudad Bolívar o Puerto Ordaz hacia Canaima. Desde Canaima se accede en curiara (bote tradicional) por los ríos Carrao y Churún. También existen tours en helicóptero.",
    nearbyPlaces:["Laguna de Canaima","Playa Orchid","Isla Anatouy","Salto Sapo","Tepuy Auyán"],
    mapQuery:"Salto Ángel Venezuela",
    allies:[1,3]
  },
  {
    id:2, title:"Los Roques", state:"Dependencias Federales", municipality:"Los Roques",
    category:"Playa", tags:["Playa","Arrecife","Buceo","Kite"],
    emoji:"🏝️", color:"#0A4A4A",
    description:"Archipiélago de Los Roques es el parque nacional marino más grande de Venezuela y el Caribe. Formado por más de 300 islotes y cayos, sus aguas turquesas y arrecifes de coral lo convierten en un paraíso del snorkel, buceo y kitesurf.",
    access:"Vuelo chárter desde Caracas (Aeropuerto La Carlota o Maiquetía) con aerolíneas como Aerotuy, Rutaca o Conviasa. Aproximadamente 45 minutos de vuelo.",
    nearbyPlaces:["Gran Roque","Cayo Francisquí","Cayo Madrisquí","Cayo Dos Mosquises","Crasqui"],
    mapQuery:"Los Roques Venezuela",
    allies:[2,4]
  },
  {
    id:3, title:"Mérida y Los Andes", state:"Mérida", municipality:"Libertador",
    category:"Montaña", tags:["Montaña","Teleférico","Nieve","Ciudad"],
    emoji:"⛰️", color:"#2A3A2A",
    description:"La ciudad universitaria de Mérida es la puerta de entrada a la Cordillera de los Andes venezolanos. Ofrece el teleférico más alto del mundo, picos nevados como el Bolívar (4.978 m), páramos y una vibrante vida cultural.",
    ...
    nearbyPlaces:["Pico Bolívar","Mucuchies","Valle de los Frailecitos","Laguna Mucubají","Pueblos del Sur"],
    mapQuery:"Merida Venezuela",
    allies:[3,5]
  },
  {
    id:4, title:"Morrocoy", state:"Falcón", municipality:"Tucupido",
    category:"Playa", tags:["Playa","Manglares","Snorkel","Pelicano"],
    emoji:"🦩", color:"#1A3A4A",
    description:"Parque Nacional Morrocoy, en el estado Falcón, ofrece cayos de arena blanca rodeados de manglares y aguas cristalinas del Mar Caribe. Sus arrecifes de coral y la abundante fauna incluyen flamencos y pelicanos.",
    access:"Carretera hacia Tucacas o Chichiriviche desde Valencia (2h) o Caracas (4h). Lanchas disponibles en ambas ciudades para acceder a los cayos. También acceso desde Barquisimeto.",
  ...
  },
  {
    ...
    emoji:"🦜", color:"#1A4A2A",
    description:"El Parque Nacional Henri Pittier es el más antiguo de Venezuela y uno de los de mayor biodiversidad del mundo. Comprende desde los Andes hasta el litoral central, con más de 500 especies de aves y playas como Choroní y Cuyagua.",
    access:"Desde Maracay por la carretera Maracay-Ocumare de la Costa. También acceso desde Valencia hacia Choroní. Transporte público desde Maracay hasta Ocumare o Choroní disponible diariamente.",
    nearbyPlaces:["Choroní","Cuyagua","Puerto Colombia","Maracay","Laguna de Maracay"],
    mapQuery:"Parque Nacional Henri Pittier Venezuela",
    allies:[3,5]
  },
  {
    id:6, title:"Ciudad Bolívar", state:"Bolívar", municipality:"Heres",
    category:"Cultura", tags:["Historia","Colonial","Río Orinoco","Arquitectura"],
    emoji:"🏛️", color:"#3A2A1A",
    description:"Ciudad Bolívar, orilla del Orinoco, es una de las ciudades coloniales mejor conservadas de Venezuela. Centro histórico declarado Patrimonio Nacional, puerta de entrada a la Gran Sabana y Ciudad Guayana. Hogar del famoso puente sobre el Orinoco.",
    access:"Aeropuerto Manuel Carlos Piar (CIU) con vuelos desde Caracas. Por carretera desde Puerto Ordaz (1h) o Caracas (8h) por la ruta troncal 19. Terminal de pasajeros con múltiples líneas.",
    nearbyPlaces:["Orinoco","Angostura","Puente Angostura","Museo Casa San Isidro","Cerro El Zamuro"],
    mapQuery:"Ciudad Bolívar Venezuela",
    allies:[1,3]
  }
];

const INIT_ALLIES = [
  {id:1,name:"Aerotuy",category:"Aerolíneas",emoji:"✈️",description:"Aerolínea venezolana especializada en vuelos chárter hacia destinos turísticos como Los Roques y Canaima.",contact:{web:"www.aerotuy.com",email:"reservas@aerotuy.com",phone:"+58 212 761-6247"},destinations:[1,2]},
  {id:2,name:"Hotel Melia Caracas",category:"Hoteles",emoji:"🏨",description:"Hotel de cinco estrellas en Caracas, punto de partida ideal para explorar Venezuela con servicio de concierge turístico.",contact:{web:"www.melia.com",email:"melia.caracas@melia.com",phone:"+58 212 762-8111"},destinations:[2,4]},
  {id:3,name:"Cacao Expeditions",category:"Tours & Guías",emoji:"🧭",description:"Operador turístico con más de 20 años de experiencia en rutas por la Gran Sabana, Los Andes y la Amazonía venezolana.",contact:{web:"www.cacaotravel.com",email:"info@cacaotravel.com",phone:"+58 212 977-1234"},destinations:[1,3,6]},
  {id:4,name:"Posada Acuarela",category:"Hoteles",emoji:"🌺",description:"Posada boutique en Los Roques con vista al mar, desayuno incluido y servicio de guías locales de buceo y pesca.",contact:{web:"posadaacuarela.com",email:"info@posadaacuarela.com",phone:"+58 416 123-4567"},destinations:[2,4]},
  {id:5,name:"La Trattoria Merideña",category:"Restaurantes",emoji:"🍽️",description:"Restaurante de alta gastronomía en Mérida fusionando cocina andina con técnicas internacionales. Premio Sabor Venezuela 2023.",contact:{web:"trattoriamerida.com",email:"reservas@trattoriamerida.com",phone:"+58 274 252-3456"},destinations:[3,5]},
];

const INIT_MESSAGES = [
  {id:1,name:"Carlos Méndez",email:"carlos@empresa.com",phone:"+58 412 555-7890",company:"Agencia Viajes CR",message:"Estamos interesados en un paquete para 30 personas a Los Roques en junio. ¿Cuáles son las tarifas de alianza para agencias? Necesitamos hospedaje y traslados incluidos.",date:"2025-06-15 10:23",status:"Sin gestionar",read:false},
  {id:2,name:"María González",email:"mgonzalez@hoteles.ve",phone:"+58 414 888-1234",company:"Hoteles Orinoco S.A.",message:"Queremos formalizar un convenio de aliado con DestinosVE. Tenemos 3 propiedades en diferentes estados.",date:"2025-06-14 15:45",status:"En proceso",read:true},
  {id:3,name:"Pedro Sulbarán",email:"psulbaran@tours.com",phone:"+58 424 333-5678",company:"TourVen Expeditions",message:"Consulta sobre tarifas publicitarias para aparecer en las fichas de destino. Tenemos tours a Mérida y Gran Sabana.",date:"2025-06-13 09:10",status:"Gestionada",read:true},
];
    ...
    <nav className="navbar">
      <div className="navbar-brand" onClick={()=>setPage("home")}>
        ...
        <div>
          ...
          <div className="brand-sub">Portal Turístico</div>
        </div>
      </div>
      <div className="nav-links">
        {[["home","Inicio"],["destinations","Destinos"],["allies","Alianzas"],["contact","Consultas"],["payments","Pagos"],["dashboard","Métricas"]].map(([p,l])=>(
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        <div>
          <div className="hero-tag">🇻🇪 &nbsp; Orgullosamente Venezolano</div>
          <h1 className="hero-title">Descubre la <em>Magia</em> de Venezuela</h1>
          <p className="hero-desc">Portal turístico oficial que conecta a viajeros con los destinos más impresionantes de Venezuela, unificando servicios de calidad bajo una red de alianzas estratégicas.</p>
          <div className="hero-btns">
            <button className="btn-primary" onClick={()=>setPage("destinations")}>🗺 Explorar Destinos</button>
            <button className="btn-outline" onClick={()=>setPage("contact")}>✉ Contactar</button>
          </div>
        </div>
        <div className="hero-stats">
          {[["6+","Destinos activos"],["5","Aliados registrados"],["100%","Venezolano"],["7","Módulos del sistema"]].map(([n,l])=>(
  ...
  return (
    <div className="section">
      <div className="section-header">
        <div className="section-tag">Módulo 01 — Catálogo</div>
        <h2 className="section-title">Destinos y Recomendaciones</h2>
        <p className="section-sub">Explora nuestra base de datos de destinos venezolanos. Cada ficha incluye información detallada, accesos y aliados vinculados.</p>
      </div>
        ...
        {filtered.map(d=>(
          <div key={d.id} className="dest-card" onClick={()=>setSelected(d)}>
            ...
            <div className="dest-body">
              ...
              <div className="dest-loc">📍 {d.state} — {d.municipality}</div>
              <div className="dest-desc">{d.description}</div>
            </div>
            <div className="dest-footer"><span style={{color:"var(--text-muted)",fontSize:".8rem"}}>{destAllies(d).length} aliado(s) vinculado(s)</span><span className="dest-arrow">→</span></div>
          </div>
        ))}
      </div>
      {selected && (
          ...
          <div className="modal-box">
            <div className="modal-header">
              ...
              <div className="modal-header-content">
                ...
                <div className="dest-loc" style={{marginBottom:0}}>📍 {selected.state} — {selected.municipality}</div>
              </div>
            </div>
            <div className="modal-body">
              <div className="modal-section"><h4>📖 Descripción</h4><p>{selected.description}</p></div>
              <div className="modal-section"><h4>🛣 Vías de Acceso</h4><p>{selected.access}</p></div>
              <div className="modal-section"><h4>🗺 Lugares Cercanos</h4>
                <div className="modal-tags">{selected.nearbyPlaces.map(p=><span key={p} className="modal-tag">📌 {p}</span>)}</div>
              </div>
              <div className="modal-section"><h4>🏷 Categorías</h4><div className="modal-tags">{selected.tags.map(t=><span key={t} className="modal-tag">{t}</span>)}</div></div>
              <div className="modal-section"><h4>🤝 Aliados Vinculados</h4>
                {destAllies(selected).length===0?<p style={{color:"var(--text-dim)"}}>No hay aliados vinculados aún</p>:
              ...
              <div className="modal-section"><h4>🗺 Ubicación</h4>
                <div className="map-placeholder">
                  <div className="map-placeholder-icon">📍</div>
                  <p>{selected.title}, {selected.state}, Venezuela</p>
                  <a className="map-link" href={`https://www.google.com/maps/search/${encodeURIComponent(selected.mapQuery)}`} target="_blank" rel="noopener noreferrer">Abrir en Google Maps ↗</a>
                </div>
              </div>
            </div>
          </div>
...
function Allies({ allies, destinations }) {
  ...
  return (
    <div className="section">
      <div className="section-header">
        <div className="section-tag">Módulo 02 — Red de Alianzas</div>
        <h2 className="section-title">Directorio de Socios</h2>
        <p className="section-sub">Red de prestadores de servicio vinculados a DestinosVE, clasificados por categoría y asociados a destinos específicos.</p>
      </div>
        ...
        {filtered.map(a=>(
          <div key={a.id} className="ally-card">
            ...
            <div className="ally-contact">
              {a.contact.web&&<a href={`https://${a.contact.web}`} target="_blank" rel="noopener noreferrer">🌐 {a.contact.web}</a>}
              {a.contact.email&&<a href={`mailto:${a.contact.email}`}>✉ {a.contact.email}</a>}
              {a.contact.phone&&<a href={`tel:${a.contact.phone}`}>📞 {a.contact.phone}</a>}
            </div>
...
function Contact({ onSubmit }) {
  ...
  return (
    <div className="section">
      <div className="section-header">
        <div className="section-tag">Módulo 03 — Consultas</div>
        <h2 className="section-title">Canal de Consultas y Negociación</h2>
        <p className="section-sub">¿Interesado en establecer una alianza o solicitar información? Envíenos su consulta directamente.</p>
      </div>
      <div className="contact-grid">
        <div className="contact-info">
          <h3>Inicie su Negociación</h3>
          <p>Todas las consultas son atendidas directamente por nuestro equipo de alianzas estratégicas. Respondemos en menos de 24 horas hábiles.</p>
          <div className="contact-features">
            {[["📥","Bandeja privada para el administrador"],["🔒","Datos protegidos y confidenciales"],["⚡","Respuesta en menos de 24 horas"],["🤝","Negociación directa sin intermediarios"],["📋","Seguimiento de su consulta en tiempo real"]].map(([i,t])=>(
        ...
        <form className="form-card" onSubmit={handle}>
          <div className="form-row">
            <div className="form-group"><label className="form-label">Nombre Completo *</label><input className="form-input" value={form.name} onChange={e=>setForm({...form,name:e.target.value})} placeholder="Ej: Carlos Méndez"/></div>
            <div className="form-group"><label className="form-label">Correo Electrónico *</label><input type="email" className="form-input" value={form.email} onChange={e=>setForm({...form,email:e.target.value})} placeholder="correo@empresa.com"/></div>
          </div>
          <div className="form-row">
            <div className="form-group"><label className="form-label">Teléfono *</label><input className="form-input" value={form.phone} onChange={e=>setForm({...form,phone:e.target.value})} placeholder="+58 412 000-0000"/></div>
          ...
          {err&&<p style={{color:"#E74C3C",fontSize:".82rem",marginBottom:".75rem"}}>⚠ {err}</p>}
          {sent&&<div className="success-msg">✅ Mensaje enviado correctamente. Un representante lo contactará pronto.</div>}
          <button type="submit" className="submit-btn" style={{marginTop:"1rem"}}>📤 Enviar Consulta</button>
        </form>
      </div>
    </div>
  );
...
function Payments() {
  const methods = [
    {icon:"🏦",name:"Transferencia Bancaria",desc:"Transferencias en bolívares y divisas a través de bancos venezolanos (Banesco, Mercantil, BBVA Provincial, BNC)."},
    {icon:"💵",name:"Divisas (USD / EUR)",desc:"Pago en efectivo o transferencia en dólares americanos o euros, según tasa oficial BCV del día de la transacción."},
    {icon:"📱",name:"Plataformas Digitales",desc:"Zelle (USA), Binance Pay (USDT), PayPal, y otras plataformas de pago electrónico previo acuerdo."},
    {icon:"🇻🇪",name:"Pago Móvil",desc:"Pago Móvil Interbancario venezolano disponible para montos en bolívares dentro del territorio nacional."},
  ];
  const statuses = [
    {cls:"pagado",dot:"pagado",name:"✅ Pagado",desc:"Monto total recibido y verificado"},
    {cls:"pendiente",dot:"pendiente",name:"⚠ Cuota Pendiente",desc:"Pago parcial recibido; saldo pendiente"},
    {cls:"verificacion",dot:"verificacion",name:"🔄 En Verificación",desc:"Comprobante enviado, pendiente confirmar"},
  ];
  return (
    <div className="section">
      <div className="section-header">
        <div className="section-tag">Módulo 04 — Pagos y Convenios</div>
        <h2 className="section-title">Gestión de Pagos, Tratos y Convenios</h2>
        <p className="section-sub">Métodos de pago aceptados, estado de transacciones y condiciones contractuales de los acuerdos comerciales.</p>
      </div>
      <div style={{marginBottom:"2rem"}}>
        <h3 style={{marginBottom:"1.25rem",fontSize:"1.2rem"}}>💳 Métodos de Pago Aceptados</h3>
      ...
      <div className="payment-status-section">
        <h3 style={{fontSize:"1.1rem",marginBottom:".25rem"}}>📊 Estatus de Transacción</h3>
        <p style={{color:"var(--text-muted)",fontSize:".85rem",marginBottom:"1rem"}}>Cada operación en DestinosVE tiene asignado un estatus para identificar la etapa de pago:</p>
      ...
      <div style={{background:"var(--card)",border:"1px solid rgba(61,122,85,.2)",borderRadius:"var(--radius)",padding:"1.5rem",marginTop:"1.5rem"}}>
        <h3 style={{fontSize:"1.1rem",marginBottom:"1rem"}}>🤝 Tipos de Convenios</h3>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:"1rem"}}>
          {[["📣","Alianza Publicitaria","Inclusión del logo, datos y links del socio en destinos vinculados de la plataforma."],["📦","Paquete Turístico","Acuerdo para venta conjunta de experiencias y servicios bajo una tarifa negociada."],["🔗","Vinculación de Destino","Asociación del aliado a destinos específicos con comisión por cada lead generado."],["📋","Contrato Marco","Acuerdo general a largo plazo con renovación semestral o anual."]].map(([i,n,d])=>(
      ...
      <div className="contrato-box">
        <h3>📜 Mini-Contrato — Términos y Condiciones</h3>
        <div className="contrato-body">
          <h4>1. OBJETO DEL CONTRATO</h4>
          <p>El presente instrumento regula las condiciones de prestación de servicios de DestinosVE Portal Turístico para aliados comerciales y usuarios que contraten servicios de difusión, vinculación o paquetes turísticos a través de la plataforma.</p>
          <h4>2. PAGOS POR CUOTAS</h4>
          <p>Los convenios podrán pagarse en hasta tres (3) cuotas. La primera cuota (mínimo 40% del monto total) deberá ser cancelada al momento de la firma del acuerdo. Las cuotas subsiguientes tendrán fechas límite establecidas en el convenio particular.</p>
          <h4>3. FECHAS LÍMITE Y PENALIZACIONES</h4>
          <p>El incumplimiento en el pago de una cuota dentro de los cinco (5) días hábiles siguientes a la fecha acordada generará un recargo del 5% sobre el saldo pendiente. Luego de quince (15) días de mora, DestinosVE se reserva el derecho de suspender la vinculación del aliado en la plataforma sin previo aviso.</p>
          <h4>4. POLÍTICA DE REEMBOLSO</h4>
          <p>Cancelaciones con más de 15 días de anticipación: reembolso del 80% del monto pagado. Cancelaciones entre 7 y 14 días: reembolso del 50%. Cancelaciones con menos de 7 días: sin derecho a reembolso. Los reembolsos se procesarán en un plazo de 10 días hábiles.</p>
          <h4>5. EJECUCIÓN DEL SERVICIO</h4>
          <p>Ningún servicio turístico, publicación o vinculación será ejecutado hasta tanto no se haya recibido y verificado el pago correspondiente (total o primera cuota en el caso de pagos fraccionados). DestinosVE se reserva el derecho de suspender servicios ante pagos pendientes o disputas no resueltas.</p>
          <h4>6. ACEPTACIÓN</h4>
          <p>El envío de un mensaje de consulta y/o comprobante de pago a través de los canales de DestinosVE implica la aceptación íntegra de los presentes términos y condiciones por parte del usuario o empresa aliada.</p>
        </div>
      </div>
    </div>
  );
...
function Dashboard({ messages, allies, destinations }) {
  ...
  const projections = [
    {pkg:"Alianza Básica (Mensual)",units:8,price:150,total:1200},
    {pkg:"Alianza Premium (Mensual)",units:4,price:350,total:1400},
    {pkg:"Paquete Publicitario",units:3,price:500,total:1500},
    {pkg:"Vinculación por Destino",units:12,price:80,total:960},
  ];
  ...
  const pieData = [
    ...
    {color:"#3D7A55",label:"Tours & Guías",val:"28%"},
    {color:"#3498DB",label:"Aerolíneas",val:"22%"},
    {color:"#E74C3C",label:"Restaurantes",val:"18%"},
  ];
  return (
    <div className="section">
      <div className="section-header">
        <div className="section-tag">Módulo 05 — Dashboard</div>
        <h2 className="section-title">Simulación de Negocio — Métricas</h2>
        <p className="section-sub">Panel de control visual con KPIs, proyecciones de ingresos y análisis de la red de alianzas.</p>
      </div>
      <div className="metrics-grid">
        <div className="metric-card gold"><div className="metric-icon">📥</div><div className="metric-val">{leads}</div><div className="metric-label">Total Consultas / Leads</div><div className="metric-trend">↑ +{managed} gestionadas</div></div>
        <div className="metric-card green"><div className="metric-icon">🤝</div><div className="metric-val">{allies.length}</div><div className="metric-label">Aliados Activos</div><div className="metric-trend">↑ Red en crecimiento</div></div>
        <div className="metric-card blue"><div className="metric-icon">🗺</div><div className="metric-val">{destinations.length}</div><div className="metric-label">Destinos Catalogados</div><div className="metric-trend">↑ 6 estados cubiertos</div></div>
        <div className="metric-card red"><div className="metric-icon">💰</div><div className="metric-val">${totalRevenue.toLocaleString()}</div><div className="metric-label">Proyección de Ingresos</div><div className="metric-trend">↑ Simulación mensual</div></div>
      </div>
      <div className="charts-grid">
        <div className="chart-card">
          <h4>📈 Consultas por Mes (Simulación)</h4>
        ...
        <div className="chart-card">
          <h4>🥧 Distribución de Aliados por Categoría</h4>
      ...
      <div className="chart-card">
        <h4>💼 Proyección de Ingresos por Paquetes</h4>
...
function AdminPanel({ messages, setMessages, destinations, setDestinations, allies, setAllies, onLogout }) {
  ...
  const [newDest,setNewDest] = useState({title:"",state:"",municipality:"",category:"Naturaleza",tags:"",emoji:"🏞",description:"",access:"",nearbyPlaces:""});
  const [newAlly,setNewAlly] = useState({name:"",category:"Hoteles",emoji:"🏨",description:"",web:"",email:"",phone:""});
  ...
  const addDest = () => {
    ...
    setNewDest({title:"",state:"",municipality:"",category:"Naturaleza",tags:"",emoji:"🏞",description:"",access:"",nearbyPlaces:""});
  ...
  const addAlly = () => {
    ...
    setNewAlly({name:"",category:"Hoteles",emoji:"🏨",description:"",web:"",email:"",phone:""});
  ...
  const sidebar = [
    {id:"inbox",icon:"📥",label:"Bandeja de Mensajes",badge:unread>0?unread:null},
    {id:"destinations",icon:"🗺",label:"Gestionar Destinos"},
    {id:"allies",icon:"🤝",label:"Gestionar Aliados"},
    {id:"payments",icon:"💳",label:"Métodos de Pago"},
    {id:"metrics",icon:"📊",label:"Resumen Métricas"},
  ];
    ...
    <div className="admin-wrapper">
      <div className="admin-sidebar">
        <div className="admin-logo">
          <h3 style={{color:"var(--gold)"}}>⚙ Backoffice</h3>
        ...
        <div className="sidebar-menu">
          ...
          <button className="sidebar-item" onClick={onLogout}><span>🚪</span><span>Cerrar Sesión</span></button>
        </div>
      </div>
      <div className="admin-content">
        {tab==="inbox" && (
          <>
            <div className="admin-header"><h2>📥 Bandeja de Mensajes</h2><div className="admin-actions"><span style={{color:"var(--text-muted)",fontSize:".85rem"}}>{messages.length} consulta(s) | {unread} sin leer</span></div></div>
            <div className="inbox-grid">
              <div className="inbox-list">
                {messages.map(m=>(
                  <div key={m.id} className={`inbox-item ${selMsg?.id===m.id?"active":""} ${!m.read?"unread":""}`} onClick={()=>markRead(m)}>
                    <div className="inbox-sender">{m.name} — {m.company}</div>
              ...
              <div className="inbox-detail">
                {!selMsg?<div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"200px",color:"var(--text-dim)",flexDirection:"column",gap:"1rem"}}><span style={{fontSize:"3rem"}}>📭</span><p>Selecciona un mensaje para leerlo</p></div>:(
                  <>
                    <div className="inbox-detail-header">
                      ...
                      <div className="inbox-meta">
                        ...
                        <div className="inbox-meta-item"><strong>Teléfono:</strong> {selMsg.phone}</div>
                    ...
                    <div className="inbox-status-row">
                      ...
                      {selMsg.status==="Gestionada"&&<span className="btn-managed">✅ Gestionada</span>}
                    </div>
                  </>
                )}
              </div>
        ...
        {tab==="destinations" && (
          <>
            <div className="admin-header"><h2>🗺 Gestionar Destinos</h2></div>
            <div className="add-form" style={{marginBottom:"2rem"}}>
              <h3 style={{marginBottom:"1.25rem",fontSize:"1rem",color:"var(--gold)"}}>➕ Agregar Nuevo Destino</h3>
              <div className="form-grid">
                <div className="form-group"><label className="form-label">Título</label><input className="form-input" value={newDest.title} onChange={e=>setNewDest({...newDest,title:e.target.value})} placeholder="Nombre del destino"/></div>
                <div className="form-group"><label className="form-label">Emoji</label><input className="form-input" value={newDest.emoji} onChange={e=>setNewDest({...newDest,emoji:e.target.value})} placeholder="🏞"/></div>
                <div className="form-group"><label className="form-label">Estado</label><input className="form-input" value={newDest.state} onChange={e=>setNewDest({...newDest,state:e.target.value})} placeholder="Ej: Bolívar"/></div>
                ...
                <div className="form-group"><label className="form-label">Categoría</label>
                  <select className="form-select" value={newDest.category} onChange={e=>setNewDest({...newDest,category:e.target.value})}>
                    {["Naturaleza","Playa","Montaña","Ecoturismo","Cultura","Aventura"].map(c=><option key={c}>{c}</option>)}
                  </select>
                </div>
              ...
              <div className="form-group"><label className="form-label">Descripción</label><textarea className="form-textarea" value={newDest.description} onChange={e=>setNewDest({...newDest,description:e.target.value})} placeholder="Descripción extensa del destino..."/></div>
              <div className="form-group"><label className="form-label">Vías de Acceso</label><input className="form-input" value={newDest.access} onChange={e=>setNewDest({...newDest,access:e.target.value})} placeholder="Cómo llegar al destino..."/></div>
              ...
              {destSuccess&&<div className="success-msg" style={{marginBottom:"1rem"}}>✅ Destino agregado exitosamente.</div>}
              <button className="btn-action primary" onClick={addDest}>💾 Guardar Destino</button>
            </div>
            <h3 style={{marginBottom:"1rem",fontSize:"1rem",color:"var(--gold)"}}>📋 Destinos Actuales ({destinations.length})</h3>
              ...
              {destinations.map(d=>(
                <div key={d.id} style={{background:"var(--card)",border:"1px solid rgba(61,122,85,.2)",borderRadius:"var(--radius-sm)",padding:"1rem",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"1rem"}}>
                  <div style={{display:"flex",alignItems:"center",gap:".75rem"}}>
                    ...
                    <div><div style={{fontWeight:700,fontSize:".9rem"}}>{d.title}</div><div style={{color:"var(--text-muted)",fontSize:".78rem"}}>{d.state} — {d.category}</div></div>
                  </div>
                  <button onClick={()=>delDest(d.id)} style={{background:"rgba(207,20,43,.15)",border:"1px solid rgba(207,20,43,.3)",color:"#E74C3C",borderRadius:"var(--radius-sm)",padding:".35rem .75rem",cursor:"pointer",fontSize:".78rem"}}>🗑 Eliminar</button>
                </div>
              ))}
            </div>
          </>
        ...
        {tab==="allies" && (
          <>
            <div className="admin-header"><h2>🤝 Gestionar Aliados</h2></div>
            <div className="add-form" style={{marginBottom:"2rem"}}>
              <h3 style={{marginBottom:"1.25rem",fontSize:"1rem",color:"var(--gold)"}}>➕ Agregar Nuevo Aliado</h3>
              <div className="form-grid">
                ...
                <div className="form-group"><label className="form-label">Emoji</label><input className="form-input" value={newAlly.emoji} onChange={e=>setNewAlly({...newAlly,emoji:e.target.value})} placeholder="🏨"/></div>
                <div className="form-group"><label className="form-label">Categoría</label>
                  <select className="form-select" value={newAlly.category} onChange={e=>setNewAlly({...newAlly,category:e.target.value})}>
                    {["Hoteles","Aerolíneas","Restaurantes","Tours & Guías","Transporte"].map(c=><option key={c}>{c}</option>)}
                  </select>
                </div>
                ...
                <div className="form-group"><label className="form-label">Teléfono</label><input className="form-input" value={newAlly.phone} onChange={e=>setNewAlly({...newAlly,phone:e.target.value})} placeholder="+58 XXX XXX-XXXX"/></div>
              </div>
              <div className="form-group"><label className="form-label">Descripción</label><textarea className="form-textarea" style={{minHeight:"80px"}} value={newAlly.description} onChange={e=>setNewAlly({...newAlly,description:e.target.value})} placeholder="Descripción del aliado..."/></div>
              {allySuccess&&<div className="success-msg" style={{marginBottom:"1rem"}}>✅ Aliado agregado exitosamente.</div>}
              <button className="btn-action primary" onClick={addAlly}>💾 Guardar Aliado</button>
            </div>
            <h3 style={{marginBottom:"1rem",fontSize:"1rem",color:"var(--gold)"}}>📋 Aliados Actuales ({allies.length})</h3>
            <div style={{display:"flex",flexDirection:"column",gap:".75rem"}}>
              {allies.map(a=>(
                <div key={a.id} style={{background:"var(--card)",border:"1px solid rgba(61,122,85,.2)",borderRadius:"var(--radius-sm)",padding:"1rem",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"1rem"}}>
                  ...
                  <button onClick={()=>delAlly(a.id)} style={{background:"rgba(207,20,43,.15)",border:"1px solid rgba(207,20,43,.3)",color:"#E74C3C",borderRadius:"var(--radius-sm)",padding:".35rem .75rem",cursor:"pointer",fontSize:".78rem"}}>🗑 Eliminar</button>
                </div>
              ))}
            </div>
          </>
        ...
        {tab==="payments" && (
          <><div className="admin-header"><h2>💳 Configurar Métodos de Pago</h2></div>
          <div style={{background:"var(--card)",border:"1px solid rgba(61,122,85,.2)",borderRadius:"var(--radius)",padding:"1.5rem"}}>
            <p style={{color:"var(--text-muted)",marginBottom:"1.5rem",fontSize:".9rem"}}>Los métodos de pago actualmente configurados para DestinosVE son:</p>
            {[{icon:"🏦",name:"Transferencia Bancaria",status:"✅ Activo"},{icon:"💵",name:"Divisas USD/EUR",status:"✅ Activo"},{icon:"📱",name:"Plataformas Digitales",status:"✅ Activo"},{icon:"🇻🇪",name:"Pago Móvil",status:"✅ Activo"}].map(m=>(
        ...
        {tab==="metrics" && (
          <><div className="admin-header"><h2>📊 Resumen de Métricas</h2></div>
          <div className="metrics-grid">
            <div className="metric-card gold"><div className="metric-icon">📥</div><div className="metric-val">{messages.length}</div><div className="metric-label">Total Consultas</div></div>
            <div className="metric-card green"><div className="metric-icon">✅</div><div className="metric-val">{messages.filter(m=>m.status==="Gestionada").length}</div><div className="metric-label">Gestionadas</div></div>
            <div className="metric-card blue"><div className="metric-icon">🤝</div><div className="metric-val">{allies.length}</div><div className="metric-label">Aliados Activos</div></div>
            <div className="metric-card red"><div className="metric-icon">🗺</div><div className="metric-val">{destinations.length}</div><div className="metric-label">Destinos</div></div>
          </div></>
        )}
      </div>
    </div>
...
function Login({ onLogin }) {
  ...
  const handle = (e) => {
    ...
    setErr("Credenciales incorrectas. Usuario: admin | Contraseña: destinosve2025");
  };
  return (
    <div className="login-wrapper">
      <div className="login-box">
        <div style={{textAlign:"center",marginBottom:"1.5rem",fontSize:"2.5rem"}}>🔐</div>
        <h2 className="login-title">Acceso Administrativo</h2>
        <p className="login-sub">Portal DestinosVE — Backoffice</p>
        <form onSubmit={handle}>
          ...
          <div className="form-group"><label className="form-label">Contraseña</label><input type="password" className="form-input" value={p} onChange={e=>setP(e.target.value)} placeholder="••••••••••"/></div>
    ...
    <footer className="footer">
      <div className="footer-grid">
        <div className="footer-brand">
          ...
          <p>Portal turístico venezolano que conecta viajeros con los destinos más hermosos de Venezuela, construyendo una red de alianzas estratégicas para el desarrollo del turismo nacional.</p>
        </div>
        <div className="footer-col"><h4>Destinos</h4>
          {["Salto Ángel","Los Roques","Mérida","Morrocoy","Henri Pittier"].map(d=><a key={d} href="#" onClick={e=>{e.preventDefault();setPage("destinations");}}>{d}</a>)}
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2025 DestinosVE — Portal Turístico Venezolano · Proyecto Universitario UNEXCA · Todos los derechos reservados</p>
      </div>
    </footer>
  );
}
